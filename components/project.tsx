...
export default function Project({ url, title, tags, imageUrl, description }: ProjectProps) {
    ...
    const containerClassName = "flex flex-col relative group bg-gray-100 dark:bg-gray-800 max-w-[45rem] borderBlack rounded-md overflow-hidden px-2 mb-8 last-of-type:mb-0 sm:pr-8 sm:h-[20rem] sm:even:pl-8 hover:bg-[#fdfbe3] hover:border-none transition";
